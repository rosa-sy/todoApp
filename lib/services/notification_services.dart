...
class NotifyHelper {
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
    ...
    var formattedDate = DateFormat.yMEd().parse(date);
    ...
    if (scheduledDate.isBefore(now)) {
      ...
      if (repeat == 'Daily') {
        scheduledDate = tz.TZDateTime(
            tz.local, now.month, (formattedDate.day) + 1, hour, minutes);
      }
      if (repeat == 'Weekly') {
        scheduledDate = tz.TZDateTime(
            tz.local, now.month, (formattedDate.day) + 7, hour, minutes);
      }
      if (repeat == 'Monthly') {
        scheduledDate = tz.TZDateTime(tz.local, (formattedDate.month) + 1,
